...
|---|---|---|---|---|---|---|---|
| T-105 | E-102 | V1.A1 - Define packaging matrix and consumer contract | P1 | todo | nick | T-102 | source_note=.pm/inbox/raw/2026-04-30-v1-planning-kickoff.md; decision_ref=.pm/decisions/open-questions.yml; evidence_ref=docs/post-v0-roadmap.md; evidence_ref=docs/v0-closeout.md; risk=medium; Planning-only slice; no implementation execution in this task. |
| T-106 | E-102 | V1.A2 - Add packaging verification gates to CI/release flow | P1 | todo | nick | T-105 | source_note=.pm/inbox/raw/2026-04-30-v1-planning-kickoff.md; decision_ref=.pm/decisions/open-questions.yml; evidence_ref=.github/workflows/ci.yml; evidence_ref=.github/workflows/release.yml; evidence_ref=scripts/prepare_release_notes.py; risk=medium; Implementation slice follows T-105 planning contract. |
| T-107 | E-103 | V1.B1 - Formalize error contract expectations and edge-case tests | P1 | todo | nick | T-103 | source_note=.pm/inbox/raw/2026-04-30-v1-planning-kickoff.md; decision_ref=.pm/decisions/open-questions.yml; evidence_ref=tests/abi_surface.rs; evidence_ref=scripts/check_abi_parity.py; risk=medium; Focus on deterministic negative-path coverage. |
| T-108 | E-103 | V1.B2 - Harden callback lifecycle guarantees and cross-context rejection paths | P1 | todo | nick | T-107 | source_note=.pm/inbox/raw/2026-04-30-v1-planning-kickoff.md; decision_ref=.pm/decisions/open-questions.yml; evidence_ref=tests/abi_surface.rs; evidence_ref=harness/consumer_smoke_callback.c; risk=medium; Supersedes earlier panic-unwind test approach that caused SIGABRT. |
