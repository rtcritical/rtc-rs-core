# RTC GitHub Release Verification Checklist

- [ ] preflight go/no-go checks complete (PM state, required checks green, clean tree)
- [ ] release commit SHA recorded before tag push
...
- [ ] incident record captured if superseding tag was required
